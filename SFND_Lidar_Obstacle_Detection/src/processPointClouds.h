...
public:
    ...
    // For the project
    std::vector<typename pcl::PointCloud<PointT>::Ptr> ClusteringKdTree(typename pcl::PointCloud<PointT>::Ptr cloud, float clusterTolerance, int minSize, int maxSize);
